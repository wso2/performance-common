 ...
 */
public class EchoHttp2ServerHandler extends Http2ConnectionHandler implements Http2FrameListener {

    private static final ByteBuf RESPONSE_BYTES = unreleasableBuffer(copiedBuffer("Hello World", CharsetUtil.UTF_8));
    private String contentType = null;

    EchoHttp2ServerHandler(Http2ConnectionDecoder decoder, Http2ConnectionEncoder encoder,
